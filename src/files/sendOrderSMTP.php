<?php
  ...
  */
  ...
  $mail->Subject = 'Order mail'; // Title email
  ...
  if(trim(!empty($_POST['email']))){
      $body.='<p><strong>E-mail/phone: </strong>'.$_POST['email'].'</p>';
  }
  if(trim(!empty($_POST['shipppingSelect']))){
    $body.='<p><strong>Shippping: </strong>'.$_POST['shipppingSelect'].'</p>';
}
  if(trim(!empty($_POST['message']))){
      $body.='<p><strong>Message: </strong>'.$_POST['message'].'</p>';
  }
  if(trim(!empty($_POST['table']))){
    $body.='<div><strong>Product: </strong><br>'.$_POST['table'].'</p>';
  }
